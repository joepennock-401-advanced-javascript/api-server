...
let notMongo = []; 
let memoryProductHandlers = {};

// post one product
memoryProductHandlers.createOneProduct = function(req, res, next){
...
// get all products
memoryProductHandlers.getAllProducts = function(req, res, next){
...
memoryProductHandlers.getOneProductById = function(req, res, next){
...
memoryProductHandlers.updateProductById = function(req, res, next){
...
memoryProductHandlers.deleteOneProductById = function(req, res, next){
...
module.exports = memoryProductHandlers;