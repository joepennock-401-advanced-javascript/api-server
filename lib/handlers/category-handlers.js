...
// create new category
categoryHandlers.createOneCategory = function(req, res, next){
...
// get all categories
categoryHandlers.getAllCategories = function(req, res, next){
...
categoryHandlers.getOneCategoryById = function(req, res, next){
...
categoryHandlers.updateCategoryById = function(req, res, next){
...
categoryHandlers.deleteOneCategoryById = function(req, res, next){
